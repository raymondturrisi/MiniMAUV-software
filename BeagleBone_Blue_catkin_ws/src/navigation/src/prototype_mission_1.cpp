...
* 	-
* @log
* 	11/14/2020: Created prototype_mission_1
*
*
*/
...
int main(int argc, char **argv) {
  ...
  ros::Subscriber leaking_sub = pm1.subscribe("heartbeat/leaking", 1, leakingCallback);
  ...
  while(ros::ok()) {
    ...
    //Hold in horizontal cruising for 60 seconds >> for ~~
    hfleft_ang.data = 180;
    hfright_ang.data = 180;
    escleft.data = 1500;
    escright.data = 1500;
